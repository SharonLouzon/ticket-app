...
public class UserService {
	...
	public Map<String, String> register(User user) {
		...
		//			|| user.getPublicKey() == null)
			...
			String publicKeyAsString = Base64.getEncoder().encodeToString(rsaKeyPair.getPublic().getEncoded());  // turn bytes into a string using encoder.
			String privateKeyAsString = Base64.getEncoder().encodeToString(rsaKeyPair.getPrivate().getEncoded());  // turn bytes into a string using encoder.		
			user.setPublicKey(publicKeyAsString);
			...
			response.put("publicKey", userResponse.getPublicKey());
			response.put("privateKey", privateKeyAsString);
